...
################################################################################
# trim.tspot.output defaults to terse when an invalid verbosity argument is passed
test_that("trim.tspot.output defaults to terse and gives a warning when an invalid verbosity argument is passed", {

expect_that(trim.tspot.output("Positive dood!"), equals("Positive"))
expect_that(trim.tspot.output("Positive dood!", "loquacious"), equals("Positive"))
expect_that(trim.tspot.output("Positive dood!", "1"), equals("Positive"))
expect_that(trim.tspot.output("Positive dood!", NA), equals("Positive"))

# trim.tspot.output warns when an invalid verbosity argument is passed
expect_that(trim.tspot.output("Positive dood!", "loquacious"), gives_warning())
expect_that(trim.tspot.output("Positive dood!", "1"), gives_warning())
expect_that(trim.tspot.output("Positive dood!", NA), gives_warning())

})


################################################################################
# trim.tspot.output returns appropriate result permutations
test_that("trim.tspot.output returns appropriate result permutations", {

expect_that(trim.tspot.output("Positive dood!"), equals("Positive"))
expect_that(trim.tspot.output("Positive dood!", "onechar"), equals("P"))
expect_that(trim.tspot.output("Positive dood!", "terse"), equals("Positive"))
expect_that(trim.tspot.output("Positive dood!", "verbose"), 
