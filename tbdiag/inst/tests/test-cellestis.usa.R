...
load(file.path("..", "..", "data", "dorman2012.rdata"))

# Compute results
fun.result <- trim.output(qft.criteria.cellestis.usa(dorman2012), "terse")
...
expect_that(all.equal(dorman2012$lab.result, fun.result), is_true())
