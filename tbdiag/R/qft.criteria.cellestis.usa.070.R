...
################################################################################
# Cellestis' USA standards with a TB - Nil cutoff = 0.70 instead of 0.35

qft.criteria.cellestis.usa.070 <- function(qft.obj){
    # This method calculates the QFT interpretation based on
    # Cellestis' American criteria with a cutoff of 0.70
    ...
    # Positive
    result[is.na(result) &
           (qft.obj$tb - qft.obj$nil + tol > 0.70) & 
